...
# yil = 2026 - int(yosh)
# print(f"{ism.title()}, siz {yil}yilda tog\'ilgansiz.")
...
# savol = ("Yaxshi ko\'rgan kitobingiz nomini kiriting ")
# savol += ("tugatish uchun'stop' deb yozing:")
# kitob = ""
# while savol != "stop":
#     kitob = input(savol)
#     if kitob == "stop":
...
#         signal = False
#     elif int(age) <= 7:
#         print("The price is: 2000 so\'m")
#     elif 7 < int(age) <= 18:
#         print("The price is: 3000 so\'m")
#     elif 18 < int(age) <= 65:
#         print("The price is: 10000 so\'m")
#     else:
#         print("The ticket is free!")
#
# while True:
...
# buyurtmalar = []
# while True:
#     buyurtma = input("Buyutrma nomini kiriting: ")
#     buyurtmalar.append(buyurtma)
#     takror = input("Yana nimadir qo'shasizmi? ")
#     if takror != "ha":
#        break
#
# print(buyurtmalar)

e_bozor = ['olma', 'nok', 'yog\'', 'choy']
korzinka = {}
while True:
    mahsulot = input("Mahsulot nomini kiriting: ")
    if mahsulot not in e_bozor:
        print("Bizda bu mahsulot yo'q")
    else:
        narx = input("Mahsulot narxi: ")
        korzinka[mahsulot] = int(narx)
        takror = input("Yana nimadir qo'shasizmi? ")
        if takror != "ha":
            break
print(korzinka)
